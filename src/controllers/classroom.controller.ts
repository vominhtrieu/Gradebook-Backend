...
export async function createGradeStructuresHandler(req: Request, res: Response) {
    try {
        const user = req.headers["userData"] as any;
        const params: any = req.params;
        const ok = await checkValidTeacher(params.id, user.id);
...
export async function updateGradeStructuresHandler(req: Request, res: Response) {
    try {
        const user = req.headers["userData"] as any;
        const params: any = req.params;
        const ok = await checkValidTeacher(params.id, user.id);
...
export async function deleteGradeStructuresHandler(req: Request, res: Response) {
    try {
        const user = req.headers["userData"] as any;
        const params: any = req.params;
        const ok = await checkValidTeacher(params.id, user.id);
